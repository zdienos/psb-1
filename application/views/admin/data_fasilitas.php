            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="btn-group pull-right">
                        <button type="button" onclick="render('tambah_fasilitas')" class="btn btn-primary" title="Tambah Fasilitas"><i class="fa fa-plus"></i></button>
...
<script>
    var thisTable = $('#myTable').DataTable({ "processing": true, "pageLength": 25, "serverSide": true, "order": [], "ajax": { "url": base_url + "api/get_fasilitas", "type": "post" }, "columnDefs": [{ "targets": [0,1,2], "orderable": false, }, ], });
